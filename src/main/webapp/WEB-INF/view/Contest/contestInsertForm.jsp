...
<script type="text/javascript">
	$(function(){
		if($('input:checkbox[id="contestPrizeWay"]').val() != "상금"){
			$("#contestPrize").attr("disabled", true);
		}
	}); 
</script> -->
<script type="text/javascript">
...
<body>
<form:form action="contestInsert" method="post" enctype="multipart/form-data" name="frm" commandName="contestCommand">
	<div id="aDiv" align="center">
		<table border="1" id="insertTable">
			<tr>
				<th>담당자</th>
				<td><form:input path="contestOrganizer"/></td>
			</tr>
			<tr>
				<th>공모전이름</th>
