...
<body>
	<form:form action="shopReviewPro" id="frm" method="post" commandName="shopReviewCommand">
		...
		<div class="sra"> 작성자 &nbsp;:&nbsp;${auto} </div> <br><br>
		
		<!-- 1번 별표요! -->
	<label class="a1"> 정확성 : </label>
	<span class="star-input1">
		<span class="input1">
	    	<input type="radio" name="shopReviewStar1" value="1" id="p1">
	    	<label for="p1">1</label>
	    	<input type="radio" name="shopReviewStar1" value="2" id="p2">
	    	<label for="p2">2</label>
	    	<input type="radio" name="shopReviewStar1" value="3" id="p3">
	    	<label for="p3">3</label>
	    	<input type="radio" name="shopReviewStar1" value="4" id="p4">
	    	<label for="p4">4</label>
	    	<input type="radio" name="shopReviewStar1" value="5" id="p5">
	...
	<span class="star-input2">
		<span class="input2">
	    	<input type="radio" name="shopReviewStar2" value="1" id="p6">
	    	<label for="p6">1</label>
	    	<input type="radio" name="shopReviewStar2" value="2" id="p7">
	    	<label for="p7">2</label>
	    	<input type="radio" name="shopReviewStar2" value="3" id="p8">
	    	<label for="p8">3</label>
	    	<input type="radio" name="shopReviewStar2" value="4" id="p9">
	    	<label for="p9">4</label>
	    	<input type="radio" name="shopReviewStar2" value="5" id="p10">
	...
	<span class="star-input3">
		<span class="input3">
	    	<input type="radio" name="shopReviewStar3" value="1" id="p11">
	    	<label for="p11">1</label>
	    	<input type="radio" name="shopReviewStar3" value="2" id="p12">
	    	<label for="p12">2</label>
	    	<input type="radio" name="shopReviewStar3" value="3" id="p13">
	    	<label for="p13">3</label>
	    	<input type="radio" name="shopReviewStar3" value="4" id="p14">
	    	<label for="p14">4</label>
	    	<input type="radio" name="shopReviewStar3" value="5" id="p15">
	...
	<span class="star-input4">
		<span class="input4">
	    	<input type="radio" name="shopReviewStar4" value="1" id="p16">
	    	<label for="p16">1</label>
	    	<input type="radio" name="shopReviewStar4" value="2" id="p17">
	    	<label for="p17">2</label>
	    	<input type="radio" name="shopReviewStar4" value="3" id="p18">
	    	<label for="p18">3</label>
	    	<input type="radio" name="shopReviewStar4" value="4" id="p19">
	    	<label for="p19">4</label>
	    	<input type="radio" name="shopReviewStar4" value="5" id="p20">
	    	<label for="p20">5</label>
	  	</span>			
	</span>
		
		<form:textarea path="shopReviewContext" id="shopReviewContext" rows="20" cols="80" cssClass="txt"/><br/><br/>
