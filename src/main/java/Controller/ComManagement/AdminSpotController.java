...
import Service.ComManagement.AdminSpotService;
...
public class AdminSpotController {
	...
	@RequestMapping("/adminspot")
	public String form(SpotCommand spotCommand) {
		
		return "Admin/adminVspot";
	}
	 

	@RequestMapping("/adminVspotPro") 
